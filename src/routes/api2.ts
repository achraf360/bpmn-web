  ...
  config() {
    ...
    router.get(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        ...
        try {
          ...
          console.log("getUser: ", self.getUser(request));
          let user = new SecureUser(request.body.user);
          console.log("user : ", user);
          let user2 = user.isSystem;
    ...
    router.post(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        try {
          ...
          context = await api.engine.start(
            name,
            data,
            self.getUser(request),
            options
    ...
    router.put(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        ...
        let errors;
        try {
          context = await api.engine.assign(
            query,
            data,
            assignment,
            self.getUser(request)
    ...
    router.put(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        ...
        let errors;
        try {
          context = await api.engine.invoke(
            query,
            data,
            self.getUser(request),
            options
    ...
    router.post(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        try {
          ...
          context = await api.engine.throwMessage(
            messageId,
            data,
            messageMatchingKey,
            self.getUser(request),
    ...
    router.post(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        ...
        let errors;
        try {
          context = await api.engine.startEvent(
            instanceId,
            startNodeId,
            data,
            self.getUser(request),
    ...
    router.post(
      ...
      awaitAppDelegateFactory(async (request, response) => {
        try {
          ...
          context = await api.engine.throwSignal(
            signalId,
            data,
            messageMatchingKey,
            self.getUser(request),
