...
export class WebApp {
  ...
  setupRoutes() {
    ...
    router.use(
      "/",
      express.static(path.join(root, "public"), { maxAge: 31557600000 })
    );
    router.use(
      "/js/lib",
    ...
    router.use(
      "/js/lib",
      express.static(path.join(root, "node_modules/popper.js/dist/umd"), {
        maxAge: 31557600000,
      })
    );
    router.use(
      "/js/lib",
      express.static(path.join(root, "node_modules/bootstrap/dist/js"), {
        maxAge: 31557600000,
      })
    );
    router.use(
